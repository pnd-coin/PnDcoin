...
public:
    enum
    {
        PUBKEY_ADDRESS = 55, // PnDcoin addresses start with P 55
        SCRIPT_ADDRESS = 117, //start with p 117
        PUBKEY_ADDRESS_TEST = 90, //start with d 90
        SCRIPT_ADDRESS_TEST = 196, // testnet addresses start with D 30
    };
