...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 PND
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 PND mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 1312000 * COIN;
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Coinbase transaction outputs can only be spent after this number of new blocks (network rule). Since blocks try to space out a minute apart, this equates to about half a day that you have to wait to spend blocks. This will deter people from mining, then instantly selling. */
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
	//There are 1440 minutes or block periods in one day or mining difficulty period
